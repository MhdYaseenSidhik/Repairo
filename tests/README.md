...
- **Repository setup** (`tests/test_repo_setup.py`) — pins the S-1 scaffold: `docs/` and
  `designs/`, the `.env.example`, the `.gitignore` policy, the Markdown-lint config and its CI
  workflow, and this test gate.
